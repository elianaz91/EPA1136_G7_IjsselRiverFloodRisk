...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    problem_formulation_id : int {0, ..., 5}
                             ...
                             6: expected damages, dike investment costs, rfr costs, evacuation cost, and casualties
                             with exclude the direction RfR  costs and evacuation cost
                             7: Expected damages disaggregated over dike rings, dike investment cost disaggregated
                              over dike rings, casualties disaggregated over dike rings, room for the river
